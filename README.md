...
### Demo GIF
אם תרצי להראות פעולה קצרה, הוספתי כאן מקום ל־GIF הדגמה (החליפי את הקובץ `client/docs/images/demo.gif` בקובץ GIF שלך):

![Demo GIF](client/docs/images/demo.gif)

אם אין GIF, ניתן לקשר סרטון חיצוני כאן:

[🎥 סרטון הדגמה (YouTube / Drive)](https://example.com/your-demo-link)
